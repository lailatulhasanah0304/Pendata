...
Penjelasan:
* Memilih teknik yang sesuai dengan tujuan data mining.
* Menentukan metode yang paling cocok dengan jenis data yang tersedia.
* Beberapa teknik yang sering digunakan antara lain classification, clustering, dan regression.
...
* Data training digunakan untuk membuat model.
* Data testing digunakan untuk menguji kinerja model.
* Memastikan model dapat bekerja dengan baik.
...
Penjelasan:
* Menggunakan algoritma untuk membuat model.
* Melatih model menggunakan data training.
* Menghasilkan model yang dapat digunakan untuk analisis.
...
* Menentukan apakah model sudah sesuai dengan tujuan.
* Memperbaiki model jika diperlukan.

Contoh:
* Model memiliki tingkat akurasi sebesar 85%.